...
// Package stcweb provides a connection to the Ixia Web Platform.
package stcweb
...
// Option for connecting to StcAgent.
...
// WithLogin configures the StcWeb to use a custom username/password.
...
// WithHTTPClient configures StcWeb to use a custom HTTP client.
