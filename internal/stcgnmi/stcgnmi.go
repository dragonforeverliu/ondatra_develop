...
var (
	prefixToReader = map[string]*prefixReader{
		...
		"/flows":      statViewReader(stcweb.TrafficItemStatsCaption, flowStatsCaption, stcweb.EgressStatsCaption),
...
type Stats struct {
	Tables            map[string]stcweb.StatTable
...
func NewClient(ctx context.Context, name string, reader StatReader, client *stcconfig.Client, opts ...grpc.DialOption) (_ *Client, rerr error) {
