...
var (
	translateFunctions = map[string]func(stcweb.StatTable, []string, []string) (*oc.Root, error){
		portStatsCaption:               translatePortStats,
		portCPUStatsCaption:            translatePortCPUStats,
		stcweb.TrafficItemStatsCaption: translateTrafficItemStats,
		flowStatsCaption:               translateFlowStats,
		stcweb.EgressStatsCaption:      translateEgressStats,
	}
)
...
func translatePortCPUStats(in stcweb.StatTable, _, _ []string) (*oc.Root, error) {
...
func translatePortStats(in stcweb.StatTable, _, _ []string) (*oc.Root, error) {
...
func translateTrafficItemStats(in stcweb.StatTable, _, _ []string) (*oc.Root, error) {
...
func translateFlowStats(in stcweb.StatTable, _, _ []string) (*oc.Root, error) {
...
func translateEgressStats(in stcweb.StatTable, itFlows, etFlows []string) (*oc.Root, error) {
